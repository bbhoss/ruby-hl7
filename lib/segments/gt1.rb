...
class HL7::Message::Segment::GT1 < HL7::Message::Segment
  ...
  add_field :guarantor_phone_number_home
  add_field :guarantor_phone_number_business
  add_field :guarantor_date_time_of_birth
  ...
  add_field :guarantor_phone_number
  ...
  add_field :guarantor_death_date_and_time
  ...
  add_field :quarantor_employers_organization_name
  add_field :handicap
